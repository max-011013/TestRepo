...
#,"DANBY PRODUCT_M",
#"FERGUSON_M","FUJITSU_M","KLA_M","MORPHE_M","MUNCHKIN_M","SCHNEIDER_M","URBAN OUTFITTERS_M",
#"WILLIAMS SONOMA_M"
...
def createAirProfile(db,acc):
    try:
        ...
        air.to_json("_result.json", indent =1, orient="records")
...
def createOceanProfile(db,acc):
    try:
        ...
        ocean.to_json("_result2.json", indent =1, orient="records")
